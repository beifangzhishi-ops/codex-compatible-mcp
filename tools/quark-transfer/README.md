...
Account resolution reads Quark 7.x `account.json` candidates and identifies the active account only when the current Local Storage / IndexedDB log evidence is unambiguous. It does not export browser cookies or submit probe uploads.
